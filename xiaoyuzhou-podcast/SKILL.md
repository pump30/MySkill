...
4. **Format into structured notes** (核心观点、分章节摘要、金句、行动清单)
5. Provide comprehensive content for analysis
...
### Step 4: Format into Structured Notes

After merge-and-clean produces the README.md, format it into structured notes:

```bash
~/.claude/skills/xiaoyuzhou-podcast/scripts/format-notes.sh <Episode Directory>
```

**Output format** (overwrite README.md):

```markdown
---
title / podcast / host / guest / tags (YAML front matter)
---

# Title
## 嘉宾介绍 (3-5 bullet points)
## 核心观点 (3 blockquotes)
## 分章节内容 (3-6 sections with tables, lists, quotes)
## 金句摘录 (5-8 quotes)
## 行动清单 (5 actionable todos)
```

**Formatting rules:**
- Remove oral filler words and repetition
- Preserve original viewpoints without personal commentary
- Use Markdown tables for comparisons
- Use blockquotes for key quotes
- Use code blocks for formulas/models
- Keep concise — structured notes, not verbatim transcript

**Note:** This step requires Claude to read the transcript and rewrite it. The format-notes.sh script outputs the formatting instructions; Claude performs the actual transformation by reading the README.md and rewriting it in the structured format above.
